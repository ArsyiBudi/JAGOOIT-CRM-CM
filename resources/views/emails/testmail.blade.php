<html>
    ...
    <body class="p-3 bg-white text-black">
       <p>Yth, <br><strong>Bpk. Ambatukam <br>(Ngawi Institute)</strong> <br>di tempat</p><br>
       <p>Melalui email ini kami samapikan proposal penawaran ngawi musical terbesar dan terakbar tahun ini.</p><br>
