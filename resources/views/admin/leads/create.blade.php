...
@section('container')
    <div class=" hide-scrollbar w-full rounded shadow-lg bg-primary h-auto md:h-[580px]  pb-20 overflow-hidden mt-48 md:mt-0">
        <div class="px-6 overflow-auto">
            ...
            <div class="mt-8 flex justify-between pr-5"> <!-- Menggunakan kelas justify-between untuk mengatur posisi tombol -->
                <button class="bg-secondary text-white rounded-md px-4 py-2 hover:scale-95 duration-200 h-[37px] w-[97px]">Back</button>
                <button class="bg-secondary text-white rounded-md px-4 py-2 hover:scale-95 duration-200 h-[37px] w-[198px]">Create</button>
            </div>
    </div>
@endsection