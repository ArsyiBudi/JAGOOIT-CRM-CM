<div class="bg-darkSecondary w-[16%] pt-11  h-screen flex flex-col items-center fixed top-0 left-0 ">
    ...
    <div class="flex flex-col gap-4 items-center w-full ">
        ...
        <div class="items-center flex gap-2 py-2  text-white px-8 {{ request()->is('leads') ? 'bg-secondary' : '' }} w-full">
            <img src="/leads.png" class="w-[30px] h-[30px] " alt="leads">
            <a href="/leads" class="">Leads</a>
        </div>
        <div class="items-center flex gap-2 py-2 px-8 justify-between {{ request()->is('client') ? 'bg-secondary' : '' }} text-white w-full">
        ...
        <div class="submenu -mt-5 mr-2">
            <div class="items-center flex gap-2 py-2  {{ request()->is('client/ongoing') ? 'text-secondary fill-secondary' : 'text-white fill-white' }}  w-full">
                ...
                <a href="/client/ongoing">Ongoing</a>
