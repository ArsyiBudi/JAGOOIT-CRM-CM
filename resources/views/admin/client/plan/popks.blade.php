        ...
        <div class="overflow-auto bg-darkSecondary mt-5 justify-between flex flex-col text-white px-8 py-10 rounded-md gap-y-3">
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    Nama
                    <input class="rounded-md text-black bg-white" type="text" name="employee_name" value="{{ old('employee_name',@$field->employee_name)}}" id="">
                </div>
                <div class="flex-auto flex flex-col ">
                    Jabatan
                    <input class="rounded-md text-black bg-white" type="text" name="employee_position" value="{{ old('employee_position',@$field->employee_position)}}" id="">
                </div>
                <div class="flex-auto flex flex-col">
                    Alamat
                    <input class="rounded-md text-black bg-white" type="text" name="employee_address"  value="{{ old('employee_address',@$field->employee_address)}}" id="">
                </div>
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    Nama
                    <input class="rounded-md text-black bg-white" type="text" name="client_name" value="{{ old('client_name',@$field->client_name)}}" id="">
                </div>
                <div class="flex-auto flex flex-col">
                    Jabatan
                    <input class="rounded-md text-black bg-white" type="text" name="client_position" value="{{ old('client_position',@$field->client_position)}}"  id="">
                </div>
                <div class="flex-auto flex flex-col">
                    Alamat
                    <input class="rounded-md text-black bg-white" type="text" name="client_address"  value="{{ old('client_address',@$field->client_address)}}" id="">
                </div>
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div>Dari</div>
                <input class="rounded-md flex-auto text-black bg-white" type="text" name="start_date" value="{{ old('start_date',@$field->start_date)}}" id="">
                <div>Sampai</div>
                <input class="rounded-md flex-auto text-black bg-white" type="text" name="end_date" value="{{ old('end_date',@$field->end_date)}}" id="">
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    Termasuk Biaya
                    <input type="text" class="rounded-md text-black bg-white" name="included_fees" value="{{ old('included_fees',@$field->included_fees)}}" id="">
                </div>
                <div class="flex-auto flex flex-col">
                    Nominal
                    <input type="text" class="rounded-md text-black bg-white" name="nominal_fees" value="{{ old('nominal_fees',@$field->nominal_fees)}}" id="">
                </div>
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    <div>Weekday</div>
                    <input type="text" class="rounded-md text-black bg-white" name="weekday_cost" value="{{ old('weekday_cost',@$field->weekday_cost)}}">
                    <div>Weekend</div>
                    <input type="text" class="rounded-md text-black bg-white" name="weekend_cost" value="{{ old('weekend_cost',@$field->weekend_cost)}}">
                </div>
                <div class="flex-auto flex flex-col">
                    <label for="catatan-popks">Catatan</label>
                    <textarea id="catatan-popks" type="text" class=" text-black bg-white rounded-md h-full hide-scrollbar resize-none" name="notes"  value="{{ old('notes',@$field->notes)}}"></textarea>
                </div>
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    ...
                    <input type="text" class="rounded-md text-black bg-white" name="consumption_cost" value="{{ old('consumption_cost',@$field->consumption_cost)}}">
                </div>
                <div class="flex-auto flex flex-col">
                    Transport Pulang-Pergi Standar JKT-BDG
                    <input type="text" class="rounded-md h-full text-black bg-white" name="transportation_cost" value="{{ old('transportation_cost',@$field->transportation_cost)}}">
                </div>
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                Tanggal 
                <input type="date" class="w-10 text-black bg-white rounded-md" name="billing_due_date" value="{{ old('billing_due_date',@$field->billing_due_date)}}">
                Setiap Bulan dan Pembayaran Selambat-Lambatnya
                <input type="number" class="text-black bg-white rounded-md" name="billing_days" value="{{ old('billing_days',@$field->billing_days)}}">
                Hari
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    Atas Nama
                    <input type="text" class="rounded-md text-black bg-white" name="authorized_by" value="{{ old('authorized_by',@$field->authorized_by)}}">
                </div>
                <div class="flex-auto flex flex-col">
                    Nama Bank
                    <input type="text" class="rounded-md text-black bg-white" name="bank_name" value="{{ old('bank_name',@$field->bank_name)}}">
                </div>
            </div>
            <div class="flex-auto flex flex-col">
                No. Rekening
                <input type="text" class="rounded-md text-black bg-white" name="account_number" value="{{ old('account_number',@$field->account_number)}}">
            </div>
            ...
            <div class="flex flex-row flex-wrap gap-2">
                <div class="flex-auto flex flex-col">
                    Direktur JagooIT
                    <input type="text" class="rounded-md text-black bg-white" name="jagoit_director" value="{{ old('jagoit_director',@$field->jagoit_director)}}">
                </div>
                <div class="flex-auto flex flex-col">
                    Direktur Klien
                    <input type="text" class="rounded-md text-black bg-white" name="client_director" value="{{ old('client_director',@$field->client_director)}}">
                </div>
            </div>
            ...
            <div class="overflow-auto bg-darkSecondary mt-5 justify-between flex flex-col text-lightGrey px-8 py-10 rounded-md space-y-3">
                ...
                <div class="flex flex-row space-x-2">
                    <div class="flex-auto flex flex-col">
                        ...
                        <i class="ri-upload-2-fill text-3xl text-black bg-white"></i>
                    </span>
                        </label>
                    </div>
                    <div class="">
                    ...
                    <div class="flex-auto flex flex-col">
                        ...
                        <textarea id="desk-popks" type="text" class="rounded-md h-[70px] text-black bg-white hide-scrollbar resize-none" name="po_descr"></textarea>
                    </div>
