         ...
         <div class=" mt-5">
            <form action="">
                ...
                <div class="mt-2 flex justify-between items-center gap-1 md:gap-0">
                    <div>
                        <div>
                            <a href="/client/order/plan/negosiasi" class="bg-secondary text-white text-sm text-center py-1 px-2 md:px-14 rounded-md font-bold flex items-center hover:scale-95 duration-200">
                    ...
                    <div class="flex gap-4 max-sm:w-full max-sm:justify-between">
                        ...
                        <div>
                            <a href="/client/order/plan/popks">
