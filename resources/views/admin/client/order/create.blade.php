    ...
    <div class="bg-primary  rounded shadow-lg mt-6 p-6 h-[calc(90vh-90px)] overflow-y-auto hide-scrollbar">
        ...
        <div class=" flex flex-wrap md:flex-nowrap  gap-4">
            <div class="w-full md:w-1/2 mb-4">
                ...
                <input id="posisi" type="text" name="desired_position" class="text-black rounded-lg px-2 py-1 w-full bg-white mt-2">
            </div>

            <div class="w-1/5 md:w-1/2 mb-4">
                <label for="jumlah" class="text-sm text-white">Jumlah</label>
                <input id="jumlah" type="number" name="needed_qty" class="text-black rounded-lg px-2 py-1 w-full bg-white mt-1 md:mt-0">
            </div>

            <div class=" w-1/2 md:w-1/2 mb-4">
                <label for="due-date" class="text-sm text-white">Due Date</label>
                <input id="due-date" type="text" name="due_date" class="text-black rounded-lg px-2 py-1 w-full bg-white mt-1 md:mt-0">
            </div>
        </div>

        <div class="mb-4">
            <label for="job-description" class="text-sm text-white">Job Description</label>
            <input id="job-description" type="text" name="description" class="text-black rounded-lg px-2 py-1 w-full bg-white mt-2">
        </div>
        ...
        <div class=" block md:flex gap-4">
            <div class="flex flex-col gap-4 md:w-1/2">
                <div class="w-full">
                    ...
                    <div class="rounded-lg px-2 py-4 h-32 w-full bg-white mt-2">
                        <textarea id="kriteria-keterampilan" type="text" name="skills_desc" class="text-black bg-transparent  h-full w-full hide-scrollbar resize-none"></textarea>
                    </div>
                </div>
                ...
                <div class="w-full  mb-4 ">
                    ...
                    <label for="file-tor" class="flex justify-center items-center bg-white py-4 rounded-lg px-2 h-24 mt-2">
                        <input id="file-tor" type="file" name="tor_file" class="text-black rounded-lg px-2 py-4 h-24 hidden w-full bg-white" name="tor">
            ...
            <div class="flex flex-col gap-4 md:w-1/2">
                <div class="w-full">
                    ...
                    <input id="anggaran" type="text" name="budget_estimation" class="text-black rounded-lg px-2 py-4 w-full bg-white mt-2">
                </div>
                ...
                <div class="w-full mb-4">
                    ...
                    <div class="rounded-lg px-2 py-4 w-full h-[10.5rem] bg-white mt-2">
                        <textarea id="kriteria-karakteristik" type="text" name="charasteristic_desc" class="text-black bg-transparent  h-full w-full hide-scrollbar resize-none    "></textarea>
                    </div>
                </div>
            </div>
        </div>
