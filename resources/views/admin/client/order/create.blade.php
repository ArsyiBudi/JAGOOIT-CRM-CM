...
<div class="mt-10">
    ...
    <div class="bg-primary rounded shadow-lg mt-6 p-6 h-[calc(100vh-100px)] overflow-y-auto ">
        ...
        <div class="mb-4 flex items-center gap-4">
            ...
            <input id="order-id" type="text" disabled class="text-white rounded-lg px-2 py-1 bg-white">
        </div>

        <div class="mb-4">
            <label for="nama-perusahaan" class="text-sm text-white">Nama Perusahaan</label>
            <input id="nama-perusahaan" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
        </div>

        <div class="flex   gap-4">
            <div class="w-full md:w-1/2 mb-4">
                <label for="posisi" class="text-sm text-white">Posisi yang Dibutuhkan</label>
                <input id="posisi" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>

            <div class="w-full md:w-1/4 mb-4">
                <label for="jumlah" class="text-sm text-white">Jumlah</label>
                <input id="jumlah" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>

            <div class="w-full md:w-1/4 mb-4">
                <label for="due-date" class="text-sm text-white">Due Date</label>
                <input id="due-date" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>
        </div>

        <div class="mb-4">
            <label for="job-description" class="text-sm text-white">Job Description</label>
            <input id="job-description" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
        </div>
        ...
        <div class="flex flex-wrap gap-4">
            <div class="w-full md:w-1/2 mb-4">
                ...
                <input id="kriteria-keterampilan" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>
            
            <div class="w-full md:w-1/2 mb-4">
                <label for="file-tor" class="text-sm text-white">File TOR</label>
                <input id="file-tor" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-4">
            <div class="w-full md:w-1/2 mb-4">
                ...
                <input id="anggaran" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>
            
            <div class="w-full md:w-1/2 mb-4">
                <label for="kriteria-karakteristik" class="text-sm text-white">Kriteria Karakteristik</label>
                <input id="kriteria-karakteristik" type="text" class="text-white rounded-lg px-2 py-1 w-full bg-white">
            </div>
        </div>
    </div>
