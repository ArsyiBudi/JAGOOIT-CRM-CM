...
<div class=" overflow-auto bg-darkSecondary pt-0 h-screen rounded-md">
    <div class="w-full bg-darkSecondary py-10 px-8 flex  flex-col ">
        ...
        <div class=" bg-darkSecondary">
            ...
            <form action="{{ route('fetch_order') }}" method="get" class=" block md:flex items-start my-4 justify-between mb-8 w-full">
                <div class=" md:block flex items-center justify-between">
                    ...
                    <div class="md:mt-5">
                        <a class=" bg-secondary font-semibold text-sm md:text-[16px] py-1 px-3 md:px-5 rounded-lg mt-0 md:mt-7 hover:scale-95 duration-200 " href="{{ url('/client/order/create') }}">New Orders</a>
                    </div>
                    <button type="submit"></button>
                </div>
                <div class=" flex items-center gap-5 mt-5 md:mt-0">
                    <p class=" hidden md:block">Search</p>
                    <input type="text" name="search" value="{{ old('per_page', session('order_search')) }}" class=" outline-none bg-white rounded-md w-full md:w-80 py-1 px-2 text-black font-semibold placeholder-gray-400 placeholder-opacity-100 md:placeholder-opacity-0" placeholder="search" value="{{ old('search') }}">
                </div>
            </form>
