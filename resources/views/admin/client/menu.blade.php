...
<div class="overflow-auto bg-darkSecondary lg:pt-0 h-screen rounded-md hide-scrollbar">
        ...
        <div class=" bg-darkSecondary">
            ...
            <form action="{{ route('fetch_client') }}" method="get" class=" block md:flex items-start my-4 justify-between mb-8 w-full">
                ...
                <div class=" flex items-center gap-5 mt-5 md:mt-0">
                    ...
                    <input type="text" name="search" value="{{ old('search', session('client_search')) }}" class=" outline-none bg-white rounded-md w-full md:w-80 py-1 px-2 text-black font-semibold placeholder-gray-400 placeholder-opacity-100 md:placeholder-opacity-0" placeholder="search">
                </div>
            </form>
